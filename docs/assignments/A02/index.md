...
(https://www.ideastatica.com/support-center/verification-examples/single-plate-shear-connections-aisc)
...
Now that we have solved for the diameter of the pin, we can use the structural engineering standard stated before. The offset of the pin slots should be a distance of twice the diameter of the pin from the closest edge of the member. 
