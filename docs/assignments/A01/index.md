...
## Decide
- **1. Homepage Identity** — The purpose of using the homepage is to instantly give the impression that the content within this portfolio involves mechanical engineering and engineering designs. The machining picture was selected to provide visitors with a visual link between the engineering, manufacturing, and the precision involved in such tasks. The purpose of using the homepage is to give visitors a professional and organized interface from which they can know that the portfolio holds assignments and projects. The use of the picture and the precision involved in it creates an expectation that the assignments and projects will be accurate and professional.
- **2. One Intentional Customization** — Decided to modify the section label “Assignments” used in the navigation section to “Engineering Assignments.” Initially, the label “Assignments” was too generic and failed to convey to an expert visitor the nature of the content in that section. The addition of the word “Engineering” ensures that the purpose of the section is made known to visitors before opening the assignments; this satisfies the need for clear organization of the portfolio. Another change would be the section label name change from About Me to About the Engineer. This change is functional due to this portfolio needing to communicate professionalism and purpose to visitors and future employers. The section label About Me is broad and misleading to more personal information rather than information that connects the creator of the portfolio to the contents of the portfolio.  
...
My academic experience is giving me an idea of how important the whole engineering design process is and why precision, accuracy, and documentation are crucial in it. The engineering design process is also important for communicating technical information clearly and verifying that a solution satisfies its requirements. I am getting to know that successful engineering goes far beyond having a functional design solution.

My main goal is to become a mechanical engineer who is able to combine mechanical knowledge with CAD, analysis, and design skills.

- **What It Means to Defend an Engineering Decision** —
 Currently, I do not think that I can fully understand how to defend engineering decisions. However, I am starting to realize what this connects to. Defending an engineering decision would involve the ability to explain the reasoning behind certain decisions and back them up with logic, requirements, calculations, sources, and documents. When defending an engineering decision, it is important that you show that your chosen method meets all the requirements and takes into account other alternatives and trade-offs. Decisions in engineering must be backed up by information that is able to communicate to other people. I plan to gain this skill in the future as I go through my course and work on more design projects.
