...
[Screwdriver](https://patents.google.com/patent/US3985170A/en)
  ...
  b. The governing model equation is tau(max) equals T(torque) multiplied by C(the outer radius) all divided by J(moment of inertia of cross section)
